    ...
    <div className="flex min-h-[calc(100vh-57px)] items-center justify-center px-4 py-10">
      ...
      >
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.div variants={fadeUp}>
              ...
              {errors.email && (
                <motion.p initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="text-red-600 text-sm mt-2">{errors.email}</motion.p>
              )}
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              {errors.password && (
                <motion.p initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="text-red-600 text-sm mt-2">{errors.password}</motion.p>
              )}
            </motion.div>

            <div className="flex justify-end">
              <a href="#" className="text-sm font-medium text-indigo-600 transition-colors hover:text-indigo-700">Forgot password?</a>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white/70 text-slate-400 backdrop-blur-sm">or</span>
            </div>
          </div>
          ...
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
              <path fill="#EA4335" d="M12 10.2v3.92h5.45c-.24 1.26-.95 2.33-2.01 3.05l3.25 2.52c1.89-1.74 2.98-4.29 2.98-7.31 0-.72-.06-1.41-.19-2.09H12z" />
              <path fill="#34A853" d="M12 22c2.7 0 4.96-.9 6.61-2.44l-3.25-2.52c-.9.6-2.05.96-3.36.96-2.58 0-4.77-1.74-5.55-4.08H3.1v2.57A9.99 9.99 0 0012 22z" />
              <path fill="#4A90E2" d="M6.45 13.92A5.98 5.98 0 016.12 12c0-.67.12-1.31.33-1.92V7.51H3.1A9.99 9.99 0 002 12c0 1.61.39 3.13 1.1 4.49l3.35-2.57z" />
              <path fill="#FBBC05" d="M12 5.95c1.47 0 2.79.5 3.83 1.49l2.87-2.87C16.95 2.94 14.69 2 12 2A9.99 9.99 0 003.1 7.51l3.35 2.57C7.23 7.74 9.42 5.95 12 5.95z" />
            </svg>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-500 text-sm">
              ...
              <Link to="/signup">
                <span className="cursor-pointer font-semibold text-indigo-600 transition-colors hover:text-indigo-700">Create an account</span>
              </Link>
            </p>
          </div>
        </motion.div>
        ...
        <motion.p variants={fadeUp} className="mt-8 text-center text-xs text-slate-400">
          ...
          <a href="#" className="text-indigo-600 hover:text-indigo-700 hover:underline">Terms</a>{" "}and{" "}
