            ...
            <div className="flex h-full flex-col p-5 sm:p-6">
              ...
              <div className="mt-6 flex-1 overflow-y-auto pr-1 space-y-5">
                ...
                <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="rounded-xl border border-slate-200/60 bg-white/80 p-5 backdrop-blur-sm shadow-sm"
                >
                  <div className="flex flex-col items-center text-center">
                    {userData?.profilePicture ? (
                      <img
                        ...
                        alt="Profile"
                        className="h-20 w-20 rounded-full border-2 border-white object-cover shadow-lg ring-2 ring-indigo-100"
                      />
                    ) : (
                      <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 text-2xl font-bold text-white shadow-lg ring-2 ring-white">
                        {initials}
                      </div>
                    )}
                    ...
                    <div className="mt-5 w-full space-y-3 text-left">
                      {[
                        ...
                        >
                          ...
                          <p
                            className={`mt-1 text-sm font-medium text-slate-900 ${field.breakAll ? "break-all" : ""} ${field.capitalize ? "capitalize" : ""}`}
                          >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-slate-400">
                        View reports and archives
                      </p>
                    </div>
                  </div>
                  <svg
                    className="h-5 w-5 text-slate-300 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-indigo-400"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
                    <path
                ...
                >
                  {[
                    ...
                    <div
                      key={stat.label}
                      className="rounded-lg border border-slate-200/60 bg-gradient-to-br from-slate-50 to-white p-3 shadow-sm"
                    >
                      <p className="text-xs uppercase tracking-wider text-slate-400">
                        {stat.label}
                      </p>
                      <p className="mt-1 text-xl font-bold bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">
                        {stat.value}
                      </p>
                    </div>
                  ))}
